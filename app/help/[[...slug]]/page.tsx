...
const articleClassName = cn(
  ...
  "[&_li]:my-2",
  "[&_a]:font-medium [&_a]:text-[#6eb0ff] [&_a]:underline [&_a]:decoration-[#6eb0ff]/35 [&_a]:underline-offset-4",
  ...
  "[&_code]:rounded-md [&_code]:bg-white/10 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[0.95em] [&_code]:text-[#6eb0ff]",
  ...
  "[&_blockquote]:my-6 [&_blockquote]:rounded-r-[1.5rem] [&_blockquote]:border-l-4 [&_blockquote]:border-[#6eb0ff]/45 [&_blockquote]:bg-white/[0.02] [&_blockquote]:px-5 [&_blockquote]:py-4 [&_blockquote]:text-zinc-300",
