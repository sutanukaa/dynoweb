    ...
    <>
      ...
      <main className="relative overflow-hidden bg-[#050505] pt-24 text-white">
        ...
        <section className={`${pageShell} pb-12 pt-10 2xl:pb-16 2xl:pt-12`} style={pageShellStyle}>
          ...
          <h1 className="mt-5 max-w-[22ch] font-[Montserrat] text-4xl font-semibold leading-[1.02] tracking-[-0.04em] text-white sm:text-5xl xl:text-[4.2rem]">
        ...
        <section className={`${pageShell} pb-20 pt-4`} style={pageShellStyle}>
          <div className="mb-8 border-b border-white/10 pb-6">
            <p className="text-[0.72rem] font-semibold uppercase tracking-[0.28em] text-zinc-500">Early-access pilots</p>
            ...
            {pilotResults.map((result) => (
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <h3 className="font-[Montserrat] text-xl font-semibold tracking-tight text-white sm:text-2xl">
                    {result.label}
                  </h3>
                  <span className="rounded-full border border-sky-300/15 bg-sky-400/[0.07] px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-sky-200">
                    {result.volume}
                  </span>
                </div>
                ...
                <div className="mt-6 grid gap-4 lg:grid-cols-3">
                  <div className="rounded-[1.35rem] border border-white/10 bg-black/25 px-4 py-4">
                    <p className="text-xs font-semibold uppercase tracking-[0.2em] text-zinc-500">Challenge</p>
                  ...
                  <div className="rounded-[1.35rem] border border-white/10 bg-white/[0.02] px-4 py-4">
                    <p className="text-xs font-semibold uppercase tracking-[0.2em] text-zinc-500">What DynoWeb found</p>
                  ...
                  <div className="rounded-[1.35rem] border border-sky-300/14 bg-sky-400/[0.05] px-4 py-4">
                    <p className="text-xs font-semibold uppercase tracking-[0.2em] text-sky-200/80">Actions &amp; outcome</p>
        ...
        <section className={`${pageShell} pb-20`} style={pageShellStyle}>
          <div className="rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.035),rgba(255,255,255,0.015))] p-6 sm:p-8 lg:p-10">
            <p className="text-[0.74rem] font-semibold uppercase tracking-[0.28em] text-zinc-500">What drives results</p>
            <h2 className="mt-4 font-[Montserrat] text-2xl font-semibold tracking-[-0.03em] text-white sm:text-3xl">
        ...
        <section className={`${pageShell} pb-24`} style={pageShellStyle}>
          <div className="rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top,rgba(56,189,248,0.08),transparent_48%),linear-gradient(180deg,rgba(255,255,255,0.045),rgba(255,255,255,0.02))] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.24)] sm:p-8 lg:p-10">
            <p className="text-[0.74rem] font-semibold uppercase tracking-[0.28em] text-zinc-500">Get started</p>
            <h2 className="mt-4 font-[Montserrat] text-3xl font-semibold leading-[1.06] tracking-[-0.04em] text-white sm:text-4xl lg:text-[3rem]">
