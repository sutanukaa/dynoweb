  ...
  return (
    <>
      ...
      >
        ...
        <div style={{textAlign:'center', color:'rgba(255,255,255,0.38)', fontFamily:'Karla, sans-serif', fontSize:'0.82rem', paddingBottom:'16px'}}>Official contact: <a href="mailto:help@dynoweb.app" style={{color:'rgba(255,255,255,0.7)'}}>help@dynoweb.app</a></div>
      </div>
    </>
  );
}
