    ...
    <>
      <style>{`
        ...
        .sketch-accent-text {
          ...
          color: #0f172a; display: inline-block; cursor: default;
        }
        ...
        .inst .step-pill-num {
          ...
          font-size: .6rem; font-weight: 700; color: #3b6fbe;
          letter-spacing: .04em; flex-shrink: 0;
        }
        .inst .step-pill-title {
          font-size: .78rem; font-weight: 600; color: #0f172a; white-space: nowrap;
        }
      ...
      <section className="inst relative w-full overflow-hidden py-24 px-6">
        {/* Background glows */}
        <div
          style={{
            position: "absolute",
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(ellipse,rgba(99,130,200,.1) 0%,transparent 68%)",
            filter: "blur(60px)",
            pointerEvents: "none",
            zIndex: 0,
        ...
        <div
          style={{
            ...
            height: 300,
            background:
              "radial-gradient(ellipse,rgba(59,111,190,.07) 0%,transparent 70%)",
            filter: "blur(40px)",
            pointerEvents: "none",
            zIndex: 0,
          }}
        ...
        <div className="relative z-10 mx-auto max-w-6xl flex flex-col items-center text-center gap-6">
          {/* Top badge */}
          <div className="top-badge">
            <span
              style={{
                ...
                boxShadow: "0 0 6px rgba(59,111,190,.6)",
              }}
            />
            Get started in minutes
          </div>

          {/* Headline — "in 3 steps." sketched */}
          <h2
            className="sec-heading"
            style={{ animation: "fadeUp .5s ease .1s forwards", opacity: 0 }}
          >
            Up and running{" "}
            <span
              ref={sketchRef}
                ...
                <defs>
                  ...
                  <mask id="instSkMask2">
                    <rect
                      ...
                      width="100"
                      height="100"
                      fill="url(#instSkGrad2)"
                    />
                  </mask>
                </defs>
                <g mask="url(#instSkMask2)">
                  {/* Softer, smaller strokes to match body text scale */}
                  <path
                    className="sketch-fill-1"
                    d="M2 52 C20 48,42 46,62 47 C78 48,90 50,98 49"
                    stroke="#3b6fbe"
          ...
          {/* Wide dashboard image */}
          <div
            className="img-frame mt-2"
            style={{
              position: "relative",
              maxWidth: "800px",
              margin: "0 auto",
          ...
          >
            <div
              style={{
                ...
                background:
                  "radial-gradient(ellipse at 50% 0%,rgba(99,130,200,.12) 0%,transparent 55%)",
                pointerEvents: "none",
                zIndex: 1,
              }}
            />
