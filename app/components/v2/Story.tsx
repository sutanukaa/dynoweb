...
function Eyebrow({ children }: { children: React.ReactNode }) {
  return <Bracket>{children}</Bracket>;
}
...
const LEAKS = [
  {
    img: "/asset-1.png",
    label: "Sales stay flat",
    sub: "Traffic climbs, orders don't.",
    msg: "Traffic keeps climbing — the orders never follow.",
    wide: true,
    size: "h-24",
  },
  {
    img: "/asset-3.png",
    label: "Rage clicks",
    sub: "Tapping something that won't work.",
    msg: "Shoppers tapping something that isn't a link — over and over.",
    wide: false,
    size: "h-24",
  },
  {
    ...
    sub: "Added, then gone at checkout.",
    msg: "Added to cart, then gone at the checkout step.",
    wide: false,
    size: "h-40",
  },
  {
    img: "/asset-2.png",
    label: "Discount won't apply",
    sub: "The code fails in the cart.",
    msg: "The code silently fails in the cart. Night-and-day once it's fixed.",
    wide: true,
    size: "h-28",
  },
];
  ...
  return (
    ...
    <div className="relative">
        ...
        <div className="relative z-10 mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-12 px-[clamp(1.25rem,5vw,4rem)] py-24 md:grid-cols-2 md:gap-16">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mx-auto mt-6 max-w-[46ch] text-lg leading-relaxed text-[var(--ink-muted)] md:mx-0">
              Traffic&rsquo;s coming. Ads are running. The sales just
              aren&rsquo;t there. You&rsquo;ve swapped the theme, rewritten the
              descriptions, dropped the price &mdash; nothing moves. You start
              wondering if it&rsquo;s you.
            </p>
            ...
            <p className="mx-auto mt-8 max-w-[46ch] text-lg leading-relaxed text-[var(--ink-muted)] md:mx-0">
              ...
              &mdash; a discount that stops applying in the cart, a button
              nobody can tap, a checkout step that scares people off. Invisible
              to you. Obvious the moment someone watches a shopper hit it and
              leave.
            </p>
          </div>
      ...
      >
        ...
        <div className="relative z-10 mx-auto grid max-w-[1280px] grid-cols-1 items-center gap-12 px-[clamp(1.25rem,5vw,4rem)] py-24 md:grid-cols-[1fr_1.45fr] md:gap-14">
          <div className="text-center md:text-left">
            ...
            <p className="mx-auto mt-6 max-w-[46ch] text-lg leading-relaxed text-[var(--ink-muted)] md:mx-0">
              Checkout scaring people off? We deploy a popup that catches them
              the second they&rsquo;re about to leave &mdash; not a dumb timer
              that annoys people who just arrived. Not showing up on Google? We
              fix it for you.
            </p>
      ...
      >
        ...
        <div className="relative z-10 mx-auto grid max-w-[1280px] grid-cols-1 items-center gap-12 px-[clamp(1.25rem,5vw,4rem)] py-24 md:grid-cols-[1.45fr_1fr] md:gap-14">
          ...
          <div className="relative order-2 md:order-1">
            ...
            <div className="dw-float-2 dw-glass-frost absolute -bottom-6 -left-2 z-10 w-52 rounded-2xl p-4 text-left sm:-left-6">
              ...
              <p className="text-xs text-[var(--ink-muted)]">
                last month &middot; net of refunds
              </p>
            </div>
          </div>
          ...
          <div className="order-1 text-center md:order-2 md:text-left">
            ...
            <p className="mx-auto mt-6 max-w-[46ch] text-lg leading-relaxed text-[var(--ink-muted)] md:mx-0">
              Which button, which image, which page actually makes you money
              &mdash; and which is dead weight. Not a made-up &ldquo;20%
              lift.&rdquo; The recovered sale, right there in the replay,
              dollars next to it.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div className="relative z-10 mx-auto grid max-w-[1280px] grid-cols-1 items-center gap-12 px-[clamp(1.25rem,5vw,4rem)] py-24 md:grid-cols-[1fr_1.45fr] md:gap-14">
          ...
          <div className="text-center md:text-left">
            ...
            <h2 className="font-display mt-5 text-[clamp(1.875rem,3vw,2.5rem)] font-semibold leading-[1.12] tracking-[-0.025em] text-[var(--ink)]">
              It drafts. <HighlightMarker>You decide.</HighlightMarker> Every
              time.
            </h2>
            <p className="mx-auto mt-6 max-w-[46ch] text-lg leading-relaxed text-[var(--ink-muted)] md:mx-0">
              The AI does the busywork and drafts the fix &mdash; then shows you
              exactly what it&rsquo;ll change.
            </p>
            <p className="mx-auto mt-5 max-w-[46ch] font-semibold text-[var(--ink)] md:mx-0">
          ...
          <div className="relative">
            ...
            <span className="dw-float absolute -left-3 top-8 z-10 inline-flex items-center gap-2 rounded-full border border-white/60 bg-white/50 px-3.5 py-2 text-sm font-semibold text-[var(--ink)] shadow-[0_12px_30px_-10px_rgba(10,22,51,0.3),inset_0_1px_0_rgba(255,255,255,0.85)] backdrop-blur-xl backdrop-saturate-150 sm:-left-5">
              <Pencil
                className="h-3.5 w-3.5 text-[var(--blue-600)]"
                strokeWidth={2.5}
              />
              Draft ready
            </span>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(160deg,#4257d6 0%,#2f43c4 52%,#1e2a8f 100%)",
        }}
      >
        {/* Soft depth glows */}
        <div
        ...
        <div className="relative z-10 mx-auto max-w-[900px] px-[clamp(1.25rem,5vw,4rem)] py-16 text-center">
          <Bracket tone="light">How it works</Bracket>
          ...
          <p className="mx-auto mt-4 max-w-[54ch] text-base leading-relaxed text-white/70 sm:text-lg">
            Free tools stop at{" "}
            <span className="font-semibold text-white">see</span>. Paid popups
            stop at <span className="font-semibold text-white">fix</span>.
            DynoWeb is the only one that closes the loop &mdash; before you pay
            a cent.
          </p>
